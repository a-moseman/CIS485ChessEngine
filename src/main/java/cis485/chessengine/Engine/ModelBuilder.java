...
public class ModelBuilder {
    ...
    public static class Reinforcement {
        ...
        private static final int LAYER_BLOCKS = 6;
        private static final int FILTERS = 96;
        ...
        public static MultiLayerNetwork build() {
            ...
            layers[layers.length - 3] = new DenseLayer.Builder()
                    .nOut(FILTERS)
                    .build();
            layers[layers.length - 2] = new DenseLayer.Builder()
                    .nOut(FILTERS)
                    .build();
            layers[layers.length - 1] = new OutputLayer.Builder(LossFunctions.LossFunction.MSE)
                    .nOut(CLASSES)
